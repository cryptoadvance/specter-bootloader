...
def parse_recoverable_sig(b64sig, message):
    """Parses recoverable signature in Base64 format returning compact signature
    and recovered public key.
    """
    sig = a2b_base64(b64sig)[1:]
    pubkey_obj = recover_pubkey(b64sig, message)
